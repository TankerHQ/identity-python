...
def generate_user_token(trustchain_id, trustchain_private_key, user_id):
    ...
    user_id = tankersdk.crypto.generichash(user_id_buff, size=BLOCK_HASH_SIZE)
    ...
    hashed = tankersdk.crypto.generichash(random_buf + user_id, size=CHECK_HASH_BLOCK_SIZE)
